...
function* requestOTPResetPass({ payload }: BaseAction<RequestOTPParams>) {
  try {
    ...
    yield put(actions.requestOTPResetPass.success(data));
  } catch (error: any) {
    Toast.show({
      text1: error.message,
      type: "error",
...
function* resendOTP({ payload }: BaseAction<RequestOTPParams>) {
  try {
    ...
    yield put(actions.resendOTP.success(data));
  } catch (error: any) {
    Toast.show({
      text1: error.message,
      type: "error",
...
function* verifyOtpAccountPartner({
  ...
  try {
    ...
    yield put(actions.verifyOtpAccountpartner.success(data));
  } catch (error: any) {
    Toast.show({
      text1: error.message,
      type: "error",
...
function* verifyOtpResetPass({
  ...
  try {
    ...
    yield put(actions.verifyOtpResetPass.success(data));
  } catch (error: any) {
    Toast.show({
      text1: error.message,
      type: "error",
...
function* changePass({ payload }: BaseAction<ChangePassParams>) {
  try {
    ...
    yield put(actions.changePass.success(data));
  } catch (error: any) {
    Toast.show({
      text1: error.message,
      type: "error",
