  ...
  return Axios.get(`${URL_FOR_PARTNER}/product/`, { params: params })
    ...
    .catch((error) => {
      ...
      console.log(useLogStyle + "----FETCHING FAIL: ", setLogStyle("red"), {
        newGetProductByGroup: error.response,
      });
      return error;
    });
};
...
export const newGetServiceByGroup = (params) => {
  return Axios.get(`${URL_FOR_PARTNER}/service/`, { params: params })
    ...
    .catch((error) => {
      _checkError(err);
      console.log(useLogStyle + "----FETCHING FAIL: ", setLogStyle("red"), {
        newGetServiceByGroup: error.response,
      });
      return error;
    });
};
  ...
  return async (dispatch) => {
    Axios.get(`${URL_FOR_PARTNER}/service/`, { params: condition })
      ...
      .catch((error) => {
        _checkError(err);
        console.log(useLogStyle + "----FETCHING FAIL: ", setLogStyle("red"), {
          getServiceByGroup: error.response,
        });
      });
  };
};
