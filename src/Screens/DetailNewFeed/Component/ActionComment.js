...
const ActionComment = memo((props) => {
  ...
  const currentPostRedux = useSelector(
    (state) => state.postReducer?.currentPost
  );
  const currentCommentPostRedux = useSelector(
    (state) => state.postReducer?.currentCommentPost
  );
    ...
    <>
        ...
        <View style={styles.replyFor}>
          <View style={styles.replyForTitle}>
            ...
            >
              ...
              >
                {currentCommentPostRedux?.partner?.name}
              </Text>
            </View>
            <TouchableOpacity onPress={_handleCancelReply}>
              <Image
                style={sizeIcon.xxxs}
          ...
          <View style={styles.replyForContent}>
            <Text
              style={{ ...stylesFont.fontNolan, fontSize: _moderateScale(10) }}
              numberOfLines={1}
              ellipsizeMode="tail"
            >
      ...
      <View style={styles.container}>
        <View
          style={[
            styles.input,
            errors?.content && touched?.content && styles.error,
          ]}
        >
          <TextInput
