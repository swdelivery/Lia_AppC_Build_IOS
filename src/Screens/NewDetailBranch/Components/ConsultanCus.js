    ...
    return (
        <View>
            ...
            <View style={styles.box}>
                <LinearGradient
                    style={[StyleSheet.absoluteFill, { zIndex: -1, borderRadius: _moderateScale(8) }]}
                    start={{ x: 0, y: 0 }}
                    end={{ x: 0, y: 1 }}
                    locations={[0, 0.8]}
                ...
                <ScrollView showsHorizontalScrollIndicator={false} style={{ padding: _moderateScale(8 * 1.5) }} horizontal>

                    <TouchableOpacity style={{ alignItems: 'center' }}>
                        <Image
                            style={styles.imageConsul}
                            source={require(`../../../Image/consul1.png`)} />
                        <Text style={[styleText.textBlackSmall500, { marginTop: _moderateScale(4) }]}>
                            Cơ da mặt
                        </Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ alignItems: 'center' }}>
                ...
                <TouchableOpacity style={[styles.btnConsul, styleElement.centerChild]}>
                    <Text style={styleText.textWhiteNor500}>
                        Tư vấn ngay
                    </Text>
                </TouchableOpacity>
