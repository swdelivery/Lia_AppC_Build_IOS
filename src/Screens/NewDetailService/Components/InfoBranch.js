...
const InfoBranch = memo(() => {
    return (
        <View style={styles.container}>
            ...
            <View style={{ width: '100%', height: .5, backgroundColor: '#dcdedc', marginVertical: _moderateScale(8 * 2) }} />
                    ...
                    [1, 2, 3]?.map((item, index) => {
                        return(
                            <TouchableOpacity key={index} style={styles.doctorCard}>
                                ...
                                <View style={{marginLeft:_moderateScale(8), justifyContent:'center'}}>
                                    <Text style={{
