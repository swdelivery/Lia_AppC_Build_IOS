    ...
    return (
      <>
        <View>
          <Collapsible
            duration={0}
            collapsedHeight={_heightScale(170)}
            collapsed={collapsedTab1}
          >
            <View>{_renderParameterDescription(props?.htmlData)}</View>
          </Collapsible>
          ...
          {collapsedTab1 ? (
            ...
            >
              <Text
                style={{ color: BASE_COLOR, marginRight: _moderateScale(4) }}
              >
                Xem thêm
              </Text>
              <IconDArrowDownBase
            ...
            >
              <Text style={{ color: GREY, marginRight: _moderateScale(4) }}>
                Thu gọn
              </Text>
              <Image
                style={{
