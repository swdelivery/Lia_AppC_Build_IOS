    ...
    return (
        <View style={{}}>
            <View style={{ alignItems: 'center', marginTop: _moderateScale(8 * 2) }}>
                <IconBrone style={styles.iconSizeRanked} />
            ...
            <View style={styles.lineText}>
                ...
                <View style={{ flex: 1, alignItems: 'center' }}>
                    <Text style={{ ...stylesFont.fontNolanBold, fontSize: _moderateScale(16) }}>0 Điểm</Text>
                </View>
            ...
            <View style={{
                ...
                <View style={[styles.boxDetail, { backgroundColor: '#F67E4C' }]}>
                ...
                <View style={[styles.boxDetail, { backgroundColor: '#CD4F29' }]}>
                    <Text style={styles.boxDetail__textPercent}>
                        5%
                    </Text>
                    <Text style={styles.boxDetail__text}>
                ...
                <View style={{ width: _moderateScale(4) }} />
                <View style={[styles.boxDetail, { backgroundColor: '#893B10' }]}>
                    <Text style={styles.boxDetail__textPercent}>
                        8%
                    </Text>
                    <Text style={styles.boxDetail__text}>
