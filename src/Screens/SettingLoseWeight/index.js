        ...
        <ScrollView>
          ...
          >
            ...
            <TouchableOpacity
              ...
              style={[
                ...
                { marginBottom: _moderateScale(8 * 1.5) },
              ]}
            >
              <View
                style={[
          ...
          >
            ...
            <View style={[styleElement.rowAliTop]}>
              <View style={{ flex: 1 }}>
                ...
                >
                  <Text
                    style={[
                      stylesFont.fontNolan500,
                      { fontSize: _moderateScale(16), color: "#03BCE4" },
                    ]}
                  >
                    BMI:
                  </Text>
                  ...
                  <Text
                    style={[
                      ...
                      { fontSize: _moderateScale(14), alignSelf: "center" },
                    ]}
                  >
                    Bình thường
                  </Text>
                ...
                >
                  Chỉ số cơ thể thể hiện trạng thái bình thường béo phì, suy
                  dinh dưỡng.
                </Text>
                <TouchableOpacity
                  style={{
              ...
              <View
                style={{ flex: 1, marginHorizontal: _moderateScale(8 * 2) }}
              >
                <View
                  style={{
                    backgroundColor: BG_GREY_OPACITY_2,
                ...
                >
                  Lượng calo cần thiết tối thiểu cho cơ thể mỗi ngày, là lượng
                  calo nền.
                </Text>
                <TouchableOpacity
                  style={{
              ...
              <View style={{ flex: 1 }}>
                ...
                >
                  Là tổng lượng calo cần thiết cho cơ thể mỗi ngày, phản ảnh cụ
                  thể quá trình ăn uống kết hợp tập luyện của cơ thể hàng ngày.
                </Text>
                <TouchableOpacity
                  style={{
                    paddingHorizontal: _moderateScale(8 * 2),
