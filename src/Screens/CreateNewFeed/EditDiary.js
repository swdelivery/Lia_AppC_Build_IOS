...
import { BASE_COLOR, BG_BEAUTY, BG_GREY_OPACITY_3, BG_GREY_OPACITY_5, BG_GREY_OPACITY_7, BLACK_OPACITY_8, BLUE, BLUE_FB, BLUE_OCEAN, BLUE_TITLE, GREY, GREY_FOR_TITLE, MAIN_OPACITY_8, RED, SECOND_COLOR, THIRD_COLOR, WHITE, BG_GREY_OPACITY_9, BLACK_OPACITY_7, BG_GREY_OPACITY_2, BLACK } from '../../Constant/Color';
...
import { updatePartnerDiaryv2, updatePartnerDailyDiaryv2, createPartnerDiaryDaily, createPartnerDiaryDailyv2, deletePartnerDiaryDailyv2 } from '../../Redux/Action/PartnerDiary';
...
const EditDiary = (props) => {
    ...
    const _getPartnerDiaryById = async () => {
        let result = await getPartnerDiaryByIdv2(props?.route?.params?.diaryId)
    ...
    return (
        <View style={styles.container}>
                ...
                <View style={{ flex: 1 }}>
                    {
                        currPartnerDiary ?
                            <Text style={[stylesFont.fontNolan500, { fontSize: _moderateScale(16), color: BLACK }]} numberOfLines={2}>
                                Nhật ký {currPartnerDiary?.serviceName}
                            </Text>
                            : <></>
                    }
                </View>
            ...
            <View style={{
                ...
                <TouchableOpacity
                    onPress={() => {
                        navigation.navigate(ScreenKey.CREATE_NEW_FEED,{currPartnerDiary :currPartnerDiary})
                    }}
                    style={[{
