...
import { Image, StyleSheet, Text, TouchableOpacity, ScrollView, View, TextInput, Alert } from 'react-native';
...
const BookingView = memo((props) => {
    ...
    const _handleConfirmCreateBooking = async () => {
        ...
        if (_isEmpty(listAssetCodeChoice) || !currPickDate || _isEmpty(currTimeChoice) || _isEmpty(listImageBanking)) {
                        ...
                        if (listImageBanking?.length > 0) {
                            ...
                            let dataFetchCreateBooking = {
                                appointmentDate: {
                                    ...
                                    to: new Date(date.getFullYear(), date.getMonth(), date.getDate(), currTimeChoice?.to?.split(':')[0], 0, 0),
                                },
        ...
        <>
            ...
            <View style={{ flex: 1, marginTop: _moderateScale(0) }}>
                <ScrollView showsHorizontalScrollIndicator={false} horizontal>
                    <View style={{ flexDirection: 'row', paddingVertical: _moderateScale(8 * 1), paddingTop: _moderateScale(8 * 2), paddingHorizontal: _moderateScale(8 * 3), alignItems: 'center' }}>
                        {
                            listImageBanking?.map((item, index) => {
                                return (

                                    <View style={{ width: _moderateScale(180), height: _moderateScale(180), borderWidth: 0.5, borderColor: 'transparent', marginRight: _moderateScale(8 * 2) }}>
                                        <TouchableOpacity
                                            onPress={() => {
            ...
            <View style={[{ marginTop: _moderateScale(8 * 2), paddingLeft: _moderateScale(8) }]}>
                <ScrollView showsHorizontalScrollIndicator={false} horizontal>
                ...
                <View style={[styles.cateAsset, { marginTop: _moderateScale(8 * 1), paddingLeft: _moderateScale(8), alignItems: 'flex-start' }]}>
