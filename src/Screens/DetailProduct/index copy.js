...
import { GREY, WHITE, GREEN_SUCCESS, BLUE, BLUE_FB, BLACK, THIRD_COLOR, SECOND_COLOR, FOURTH_COLOR, BASE_COLOR, BG_GREY_OPACITY_5, TITLE_GREY, BTN_PRICE, RED } from '../../Constant/Color';
                ...
                <View style={[styles.bannerContainer]}>
                    ...
                    <View style={{
                        ...
                        <View style={[styleElement.rowAliCenter, { justifyContent: 'space-between', paddingHorizontal: _moderateScale(8 * 3), marginTop: _moderateScale(8 * 2) }]}>
                            ...
                            <Text style={[stylesFont.fontNolan500, { color: WHITE, fontSize: _moderateScale(16) }]}>CHI TIẾT SẢN PHẨM</Text>
                            <TouchableOpacity>
