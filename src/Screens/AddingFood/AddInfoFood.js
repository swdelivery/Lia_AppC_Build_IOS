    ...
    ImagePicker.openPicker({
      ...
      .then(async (images) => {
        ...
        props?.setFieldValue(
          ...
          resultUploadImageMessage?.data?.data
        );
  ...
  return (
    <>
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            ...
            <TextInput
              ...
              onChangeText={(value) =>
                props?.parseStringSetFieldValue("name", value)
              }
              style={[stylesFont.fontNolan, styles.input]}
              placeholder={"vd: Sữa đậu nành"}
            />
            <TextErrorRed
            ...
            props?.values?.representationFileIdArr?.length > 0 ? (
              ...
              >
                <Image
                  ...
                  source={{
                    uri: `${URL_ORIGINAL}${props?.values?.representationFileIdArr[0]?.link}`,
                  }}
                />
              </TouchableOpacity>
            ) : (
              ...
              >
                <Text
                  style={[
                    stylesFont.fontNolan500,
                    { fontSize: _moderateScale(13), color: GREY },
                  ]}
                >
                  Thêm ảnh {<Text style={{ color: RED }}>*</Text>}
                </Text>
              </TouchableOpacity>
            )
          }
      ...
      >
        <View style={{ flex: 1, marginRight: _moderateScale(8 * 2) }}>
          ...
          <TextInput
            ...
            onChangeText={(value) =>
              props?.parseNumberSetFieldValue("size", value)
            }
            style={[stylesFont.fontNolan, styles.input]}
            placeholder={"vd: 100"}
          />
        ...
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            ...
            onChangeText={(value) =>
              props?.parseStringSetFieldValue("unit", value)
            }
            style={[stylesFont.fontNolan, styles.input]}
            placeholder={"vd: gr, ml"}
          />
          <TextErrorRed
      ...
      >
        ...
        >
          Năng lượng (kcal) {<Text style={{ color: RED }}>*</Text>}
        </Text>
        <TextInput
          keyboardType={"numbers-and-punctuation"}
          onFocus={() => props?.setFieldTouched("calo")}
          onChangeText={(value) =>
            props?.parseNumberSetFieldValue("calo", value)
          }
          style={[stylesFont.fontNolan, styles.input]}
          placeholder={"vd: 1200"}
        />
        ...
        <View style={{ flex: 1 }}>
          ...
          >
            <View style={{ flex: 1, marginRight: _moderateScale(8 * 2) }}>
              ...
              >
                Chất đạm (Protein - g) {<Text style={{ color: RED }}>*</Text>}
              </Text>
              <TextInput
                keyboardType={"numbers-and-punctuation"}
                onFocus={() => props?.setFieldTouched("main.protein")}
                onChangeText={(value) =>
                  props?.parseNumberSetFieldValue("main.protein", value)
                }
                style={[stylesFont.fontNolan, styles.input]}
                placeholder={"vd: 100"}
              />
              <TextErrorRed
                isShowError={
                  props?.errors?.main?.protein && props?.touched?.main?.protein
                }
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                Carbohyrate (g) {<Text style={{ color: RED }}>*</Text>}
              </Text>
              <TextInput
                keyboardType={"numbers-and-punctuation"}
                onFocus={() => props?.setFieldTouched("main.carbohyrate")}
                onChangeText={(value) =>
                  props?.parseNumberSetFieldValue("main.carbohyrate", value)
                }
                style={[stylesFont.fontNolan, styles.input]}
                placeholder={"vd: 100"}
              />
              <TextErrorRed
                isShowError={
                  props?.errors?.main?.carbohyrate &&
                  props?.touched?.main?.carbohyrate
                }
          ...
          <View style={{ flex: 1, marginTop: _moderateScale(8 * 2) }}>
            ...
            >
              Chất béo (Fat - g) {<Text style={{ color: RED }}>*</Text>}
            </Text>
            <TextInput
              keyboardType={"numbers-and-punctuation"}
              onFocus={() => props?.setFieldTouched("main.fat")}
              onChangeText={(value) =>
                props?.parseNumberSetFieldValue("main.fat", value)
              }
              style={[stylesFont.fontNolan, styles.input]}
              placeholder={"vd: 100"}
            />
            <TextErrorRed
              isShowError={
                props?.errors?.main?.fat && props?.touched?.main?.fat
              }
