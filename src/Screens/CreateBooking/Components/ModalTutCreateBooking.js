...
const ModalTutCreateBooking = (props) => {
  ...
  const noticeNotAutoShowTutCreateBookingRedux = useSelector(
    (state) => state?.authReducer?.noticeNotAutoShowTutCreateBooking
  );
    ...
    >
      ...
      >
        ...
        {noticeNotAutoShowTutCreateBookingRedux == true ? (
          ...
          >
            <Image
              style={[sizeIcon.md, { marginRight: _moderateScale(8) }]}
