...
const ModalCashInWallet = memo((props) => {
                            ...
                            <View style={{ height: _moderateScale(8 * 32) }}>
                                ...
                                <View style={[styleElement.rowAliCenter, { marginTop: _moderateScale(4) }]}>
                                    <View style={[styleElement.rowAliCenter]}>
                                        ...
                                        {
                                            <Text selectable style={[stylesFont.fontNolanBold, { marginLeft: _moderateScale(8), fontSize: _moderateScale(14), marginTop: _moderateScale(0), color: BG_SERVICE }]}>
                                ...
                                <TextInput
                                    ...
                                    style={[stylesFont.fontNolanBold, styles.inputDeposit, { color: BLUE_FB, marginTop: _moderateScale(8) }]}
                                    ...
                                    <ScrollView showsHorizontalScrollIndicator={false} horizontal>
                                        {
                                            listImageBanking?.map((item, index) => {
                                                return (
                                                    ...
                                                    <View style={{ width: _moderateScale(80), height: _moderateScale(100), borderWidth: 0.5, borderColor: 'transparent', marginRight: _moderateScale(8 * 2) }}>
                                                        <TouchableOpacity
                                                            onPress={() => {
...
export default ModalCashInWallet;