...
import { BTN_PRICE, GREY, WHITE, BLACK_OPACITY_8, ORANGE, BG_GREY_OPACITY_5, PRICE_ORANGE, BLUE_FB, RED, BLACK, BG_GREY_OPACITY_3 } from '../../../Constant/Color';
...
const index = memo((props) => {
    ...
    return (
        <View style={{
            ...
            <View style={{ paddingHorizontal: _moderateScale(8 * 3), marginVertical: _moderateScale(8*2) }}>
                <TouchableOpacity
                    onPress={() => {
                                            ...
                                            10%
                                                    ...
                                                    <View style={{ flex: 1, marginLeft: _moderateScale(8) }}>
                                                        ...
                                                        <View style={{ flexDirection: 'row', alignItems: 'flex-end' }}>
                                                            ...
                                                            <Text numberOfLines={1} style={[stylesFont.fontNolanBold, { marginLeft: _moderateScale(4), fontSize: _moderateScale(14), color: PRICE_ORANGE }]}>
