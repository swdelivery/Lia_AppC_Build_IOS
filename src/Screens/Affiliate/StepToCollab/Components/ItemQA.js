...
import { BTN_PRICE, GREY, BLACK, BLACK_OPACITY_8, BG_GREY_OPACITY_5, BG_GREY_OPACITY_2, BG_GREY_OPACITY_3 } from '../../../../Constant/Color';
        ...
        <View>
            <TouchableOpacity
                ...
                <View style={[styleElement.rowAliTop, { paddingHorizontal: _moderateScale(8 * 2) }]}>
                    <Text style={[stylesFont.fontNolan500, { fontSize: _moderateScale(14), flex: 1 }]}>{props?.data?.question}</Text>
                    {
                        isExpand ?
                            <View>
...

                {
                    isExpand ?
                        ...
                        <View style={{padding:_moderateScale(12)}}>
