...
import { GREY, WHITE, BASE_COLOR, SECOND_COLOR, BTN_PRICE, RED, BLUE_FB, THIRD_COLOR, BLACK, BG_GREY_OPACITY_5, BG_GREY_OPACITY_2, BLACK_OPACITY_7 } from '../../../Constant/Color';
...
import { getWallet, getCurrentCommission, getCollabStatistic, getTeammateParent } from '../../../Redux/Action/InfoAction'
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} scrollIndicatorInsets={{ right: 1 }}>
                <View style={{
                    ...
                    <Text style={{
                        ...
                        color: BLACK,
                        fontStyle: 'italic'
                    }}>* Đây là cấp quản lí trực tiếp của bạn</Text>
                </View>
                <View style={{ height: _moderateScale(8 * 2.5) }} />
