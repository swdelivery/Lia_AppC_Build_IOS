...
import { getDirectCommission, getOverviewCommission } from '../../../Redux/Action/InfoAction';


const Direct = memo((props) => {

    const [listChild, setListChild] = useState([])

    useEffect(() => {
        _getDirectCommission()
    }, [])

    const _getDirectCommission = async () => {
        let result = await getDirectCommission();
        ...
        <ScrollView scrollIndicatorInsets={{right:1}}>
            <View style={{
                ...
                <Text style={{
                    ...
                    fontStyle: 'italic'
                }}>* Tiền hoa hồng bán lẻ dịch vụ cho khác hàng</Text>
            </View>
