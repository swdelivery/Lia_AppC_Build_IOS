...
const ModalExchangeToWheelTurn = memo((props) => {
  ...
  const _handleBuyTurnWheel = async () => {
    Alert.alert(
      "Xác nhận",
      `Xác nhận mua ${turnValue} lượt quay với giá ${formatMonney(
        props?.currActiveWheel?.amountPerChange * turnValue
      )} VND?`,
      [
        {
          text: "Huỷ",
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Bạn đã hết lượt quay. Thực hiện đổi lượt quay ngay để tham gia
                vòng quay may mắn !!
              </Text>
              ...
              >
                ...
                <View style={{ flex: 1.5, marginTop: _moderateScale(8 * 1.5) }}>
                  ...
                  >
                    <Text style={sizeText.large_bold}>X</Text>
                    ...
                    >
                      <Text style={sizeText.normal_bold}>{turnValue}</Text>
                    </View>
