...
import { BtnMission, IconCancelGrey } from "../../../Components/Icon/Icon";
                ...
                return (
                  <View key={index} style={styles.itemMission}>
                    <Column flex={1} marginRight={16}>
                      <Text weight="bold">{item?.bonusEvent?.name}</Text>
                      <Text
                        weight="bold"
                        color={BASE_COLOR}
                        fontStyle={"italic"}
                          ...
                          {item?.usage > 0 ? (
                            ...
                            >
                              <Text
                                style={[
                                  sizeText.small_bold,
                                  { color: BASE_COLOR, fontStyle: "italic" },
                                ]}
                              >
                                Làm ngay
                              </Text>
