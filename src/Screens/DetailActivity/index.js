      ...
      <ScrollView>
        ...
        >
          <ImageBackground
            ...
            source={{
              uri: `${URL_ORIGINAL}${
                !_isEmpty(data?.representationFileArr)
            ...
            >
              <Text
                style={[
                  ...
                  { fontSize: _moderateScale(20), color: WHITE },
                ]}
              >
                {data?.name}
              </Text>
              ...
              >
                <Image
                  style={[sizeIcon.lg]}
                  source={require("../../Icon/fire_calo.png")}
                />
                <Text
                  style={[
                    stylesFont.fontNolanBold,
                    { fontSize: _moderateScale(24), color: "#E45403" },
                  ]}
                >
          ...
          {props?.route?.params?.data?.description?.length > 0 ? (
            <View style={[{}]}>
              <Text
                style={[
                  stylesFont.fontNolan500,
                  { fontSize: _moderateScale(15), flex: 1 },
                ]}
              >
                Ghi chú
              </Text>
          ...
          >
            ...
            >
              <Text
                style={[
                  stylesFont.fontNolan500,
                  { fontSize: _moderateScale(16), color: "#E45403" },
                ]}
              >
                {parseFloat(calo?.toFixed(2))}
              </Text>
          ...
          >
            ...
            >
              ...
              >
                <View style={{ alignItems: "center" }}>
                  <Text
                    style={[
                      ...
                      { fontSize: _moderateScale(20), color: BTN_PRICE },
                    ]}
                  >
                    {parseFloat(
                      partnerTrackingWeightRedux?.caloBurned?.toFixed(2)
                    )}
                  </Text>
                  <Text
                    style={[
                      stylesFont.fontDinTextPro,
                      { fontSize: _moderateScale(16), color: BTN_PRICE },
                    ]}
                  >
                    Đốt cháy
                  </Text>
                ...
                >
                  <Text
                    style={[
                      stylesFont.fontDinTextPro,
                      { fontSize: _moderateScale(20), color: BLUE_FB },
                    ]}
                  >
                    {parseFloat(
                      partnerTrackingWeightRedux?.caloIntake?.toFixed(2)
                    )}
                  </Text>
                  <Text
                    style={[
                      stylesFont.fontDinTextPro,
                      { fontSize: _moderateScale(16), color: BLUE_FB },
                    ]}
                  >
                    Nạp vào
                  </Text>
              ...
              >
                ...
                >
                  {parseFloat(
                    partnerTrackingWeightRedux?.medicalIndex?.tdee?.toFixed(2)
                  )}
                </Text>
                <Text
                  style={[
      ...
      >
        ...
        >
          <Text
            style={[
              stylesFont.fontNolan500,
              { fontSize: _moderateScale(15), color: WHITE },
            ]}
          >
            Chọn
          </Text>
