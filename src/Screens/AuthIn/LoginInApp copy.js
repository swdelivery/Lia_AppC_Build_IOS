        ...
        <KeyboardAwareScrollView bounces={false} contentContainerStyle={{
            ...
            <View style={styles.container}>
                ...
                <ImageBackground source={require(
                    ...
                    <View style={{ position: 'absolute', top: _moderateScale(8 * 4), paddingLeft: _moderateScale(8 * 2), zIndex: 10 }}>
                        <TouchableOpacity
                ...
                <View style={{ marginTop: 40, alignItems: 'center' }}>
                    ...
                    <View style={{ width: _moderateScale(320), alignSelf: 'center', marginBottom: _moderateScale(16) }}>
                        <Button.ButtonOutline
                            pressAction={() => navigation.navigate(ScreenKey.REGISTER_IN_APP, { routeName: props?.route?.params?.routeName })}
