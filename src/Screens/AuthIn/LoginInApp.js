            ...
            <KeyboardAwareScrollView bounces={false} contentContainerStyle={{
                ...
                <View style={styles.container}>
                    ...
                    <View style={{ paddingHorizontal: _moderateScale(8 * 2) }}>
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                navigation.navigate(ScreenKey.FILL_PHONE_TO_GET_NEW_PASS, { routeName: props?.route?.params?.routeName })
                            }}
                            style={[{
                                height: _moderateScale(8 * 6),
                            ...
                            <Text style={[stylesFont.fontNolanBold, { fontSize: _moderateScale(14), color: Color.THIRD_COLOR }]}>
                                Quên mật khẩu
                            </Text>
                        </TouchableOpacity>
                        <View style={{ height: _moderateScale(8 * 2) }} />
                        ...
                        <TouchableOpacity
                            onPress={() => {
                                navigation.navigate(ScreenKey.REGISTER_IN_APP, { routeName: props?.route?.params?.routeName })
                            }}
                            style={[{
                                backgroundColor: 'transparent',
                            ...
                            <Text style={[stylesFont.fontNolan, { fontSize: _moderateScale(14), color: Color.GREY }]}>
                    ...
                    <View style={{ flex: 1, justifyContent: 'flex-end', paddingBottom: _moderateScale(32), alignSelf: 'center' }}>
                        <Text style={[stylesFont.fontDinTextPro, { color: Color.BLACK, fontSize: _moderateScale(12) }]}>
