            ...
            <View style={{ height: _moderateScale(8 * 38) }}>
              ...
              >
                <View
                  style={[
                    styleElement.rowAliCenter,
                    { marginTop: _moderateScale(4), flex: 1 },
                  ]}
                >
                  <Text
                    style={[
                      stylesFont.fontNolanBold,
                      { fontSize: _moderateScale(14), color: BG_SERVICE },
                    ]}
                  >
                    {`STK: `}
                  </Text>
                ...
                >
                  <Text style={[stylesFont.fontNolan, styles.btnCopy__text]}>
                    Copy
                  </Text>
                </TouchableOpacity>
              </View>
