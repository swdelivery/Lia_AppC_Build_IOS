...
const Tab3 = forwardRef((props, ref) => {
    ...
    switch (status) {
      case "WAIT":
        return (
          ...
          >
            <Text style={[styles.textTable, , { color: WHITE }]}>
              Chờ duyệt
            </Text>
          </View>
        );
  ...
  const _renderPaymentFor = (key) => {
    switch (key) {
      case "DEPOSIT":
        return <Text style={styles.textTable}>Cọc</Text>;
      case "ORDER":
        return <Text style={styles.textTable}>Thanh toán</Text>;
  ...
  if (props?.isActiveTab) {
    return (
      <View style={{ paddingHorizontal: _moderateScale(8 * 2), flex: 1 }}>
                          ...
                          {item?.images?.length > 0 ? (
                            ...
                            >
                              ...
                              <Image
                                ...
                                source={{
                                  uri: `${URL_ORIGINAL}${item?.images[0]?.link}`,
                                }}
                              />
                            </TouchableOpacity>
                          ) : (
            ...
            return (
              <View key={index} style={{ marginTop: _moderateScale(8 * 2) }}>
                <View style={{}}>
                  ...
                  >
                    {index + 1}. {<Text>{item?.serviceName}</Text>}
                  </Text>
                </View>
                <View
                  style={{
        ...
        <View
          style={{
            padding: _moderateScale(8 * 0),
            marginTop: _moderateScale(8 * 2),
            flexDirection: "row",
          }}
        >
          <View style={[styles.banner, { backgroundColor: "#2BAE60" }]}>
            <Text style={styles.title2}>Tổng</Text>
          ...
          <View
            style={[styles.banner, { backgroundColor: "rgba(187,84,9,.7)" }]}
          >
            <Text style={styles.title2}>Cọc</Text>
            <Text style={styles.money}>
              {formatMonney(
                Number(infoOrder?.totalAmountDeposit) -
                  Number(infoOrder?.totalRefundDeposit)
              )}
            </Text>
          </View>
        </View>
        ...
        >
          <View style={[styles.banner, { backgroundColor: "#2AA9F4" }]}>
            <Text style={styles.title2}>Đã trả</Text>
            <Text style={styles.money}>
          ...
          <View style={[styles.banner, { backgroundColor: "#424242" }]}>
            <Text style={styles.title2}>Hoàn tiền</Text>
            <Text style={styles.money}>
        ...
        >
          <View style={[styles.banner, { backgroundColor: SECOND_COLOR }]}>
            <Text style={styles.title2}>Còn lại</Text>
            <Text style={styles.money}>
