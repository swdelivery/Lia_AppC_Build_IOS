      ...
      >
        <View style={[styles.headOfFeed]}>
          <TouchableOpacity
            onPress={() => {
              if (props?.data?.partner?._id == infoUserRedux?._id) {
                ...
                navigation.navigate(ScreenKey.OTHER_PERSONAL_PAGE, {
                  userId: props?.data?.partner?._id,
                });
              }
            }}
          ...
          >
            <FastImage
              ...
              uri={
                props?.data?.partner?.fileAvatar?.link
                  ? `${URL_ORIGINAL}${props?.data?.partner?.fileAvatar?.link}`
                  : URL_AVATAR_DEFAULT
              }
            />
            <View style={[styles.titOfFeed]}>
              ...
              <View
                style={{ flexDirection: "row", marginTop: _moderateScale(4) }}
              >
                ...
                <Text
                  style={[styles.timeFeed, { marginLeft: _moderateScale(4) }]}
                >
          ...
          {infoUserRedux?._id === props?.data?.partnerId ? (
            ...
            >
              <Image source={require("../../../Image/component/more.png")} />
            </TouchableOpacity>
          ) : (
            <></>
          )}
        ...
        <View style={[styles.contentFeed]}>
          {props?.data?.content?.length > 0 ? (
            <TouchableOpacity activeOpacity={0.8} onPress={_handleDetail}>
              <Text
                numberOfLines={4}
                onTextLayout={(e) =>
          ...
          >
            <TouchableOpacity
              onPress={() => {
                ...
                setListImagesSeeCurr([
                  ...props?.data?.template?.data?.imageBeforeTreatment,
                  ...props?.data?.template?.data?.imageAfterTreatment,
                ]);
              }}
            ...
            <TouchableOpacity
              onPress={() => {
                setShowImageViewing(true);
                setIndexCurrImageView(
                  props?.data?.template?.data?.imageBeforeTreatment?.length
                );
          ...
          <TouchableOpacity onPress={_handleDetail} style={[styles.shareFeed]}>
