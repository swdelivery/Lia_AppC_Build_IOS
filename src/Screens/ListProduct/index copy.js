...
import { getAllProductGroup, getProductByGroup } from '../../Redux/Action/ProductGroup';
...
const ListProduct = () => {
    ...
    useEffect(() => {
        if (currentGroup !== '') {
            ...
            dispatch(getProductByGroup(condition))
        }
    }, [currentGroup])
                    ...
                    <View style={{
                        ...
                        <View style={[styles.listCategoryProduct]} >
                            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                                {
                                    listProductGroupRedux?.map((item, index) => {
                                        // return item.code!==currentGroup?

                                        return (
                                            <TouchableOpacity
                                                onPress={() => setCurrentGroup(item.code)}
                                                style={[styles.categoryProduct]} key={index} >
                        ...
                        <Text style={{
                            ...
                            {find(listProductGroupRedux, { code: currentGroup })?.name}
                        </Text>
