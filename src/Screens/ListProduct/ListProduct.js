...
import { BG_GREY_OPACITY_3, GREY, WHITE } from '../../Constant/Color';
...
import { newGetServiceByGroup, newGetProductByGroup } from '../../Redux/Action/ServiceGroup';
...
const ListService = memo((props) => {
    ...
    const _getServiceByGRCode = async (codeGR) => {
        ...
        let result = await newGetProductByGroup(condition)
    ...
    const _handlePressDetail = (_id) => {
        navigation.navigate(ScreenKey.DETAIL_PRODUCT, { idProduct: _id })
    }
