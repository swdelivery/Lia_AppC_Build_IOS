...
import { Alert, LayoutAnimation, ScrollView, StyleSheet, TouchableOpacity, View, Text } from 'react-native'
import Animated, { runOnJS, useAnimatedStyle, useSharedValue, withTiming } from 'react-native-reanimated'
import { useSelector } from 'react-redux'
import { BtnHistory, IconCancelGrey } from '../../../Components/Icon/Icon'
import { BASE_COLOR, BLACK, BLUE_FB, BORDER_COLOR, GREY_FOR_TITLE, PRICE_ORANGE, WHITE } from '../../../Constant/Color'
