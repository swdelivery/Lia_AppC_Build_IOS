    ...
    <>
      <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {morning.map((item, ind) => {
            ...
            return morningChoose.indexOf(item) > -1 ? (
              <TouchableOpacity
                ...
                style={[
                  styleElement.rowAliCenter,
                  {
                    ...
                    marginBottom: _moderateScale(20),
                  },
                ]}
              >
                <Image
                  style={[sizeIcon.lg]}
                  source={require("../../../Icon/a_check.png")}
                />
                <Text
                  style={[
              ...
              >
                <Image
                  style={[sizeIcon.lg]}
                  source={require("../../../Icon/i_check_grey.png")}
                />
                <Text
                  style={[
                    stylesFont.fontNolan500,
        ...
        >
          ...
          >
            <Text style={{ color: WHITE, fontSize: _moderateScale(14) }}>
              Cập nhật
            </Text>
          </TouchableOpacity>
          ...
          _findIndex(listImage, { type: "right" }) > -1 ? (
            <TouchableOpacity
              ...
              style={[
                styles.btnOptions,
                { backgroundColor: BLUE_OCEAN, borderColor: BLUE_OCEAN },
              ]}
            >
              <Text style={{ color: WHITE, fontSize: _moderateScale(14) }}>
                Hoàn thành
