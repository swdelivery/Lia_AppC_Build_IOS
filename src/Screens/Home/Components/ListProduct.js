...
import { WHITE, BASE_COLOR, SECOND_COLOR, THIRD_COLOR, GREY, BTN_PRICE, BG_GREY_OPACITY_2, BG_GREY_OPACITY_5, BLACK_OPACITY_8, PRICE_ORANGE, BLUE_FB } from '../../../Constant/Color';
    ...
    return (
        <View>
...

            {
                listProduct?.length > 0 ?
                    <>
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', paddingTop: _moderateScale(0) }}>
                            {
                    ...
                    <>
                        <View style={{ height: 1000 }}>
                            <Text style={{ ...stylesFont.fontNolan500, color: GREY, fontSize: _moderateScale(14), fontStyle: 'italic', alignSelf: 'center', marginTop: 100 }}>
                                Đang cập nhật
                            </Text>
                        </View>
                    </>
