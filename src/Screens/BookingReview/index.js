...
import { createReviewTreatment, getReviewByTreatmentDetailForPartner, getPrepareReviewForTreatmentDetail, createReviewBooking, getBookingReviews } from '../../Redux/Action/BookingAction';
...
const index = memo((props) => {
    ...
    const _getDataReview = async (dataReviewBooking) => {
        ...
        let arrayKey = ["securityReview", "receptionReview", "consultantReview", "csReview", "branchReview"];
        let listAllStar = []
    ...
    const _handleConfirmFeedBack = async () => {
        ...
        let resultCreateReviewTreatment = await createReviewBooking(dataForFetchTemp)
