        ...
        <View style={styles.container}>
            ...
            <ImageBackground
                    ...
                    <View style={[styleElement.rowAliCenter, { flex: 1, justifyContent: 'space-between' }]}>
                        ...
                        <TouchableOpacity
                            ...
                            <View style={[styleElement.rowAliCenter]}>
                                ...
                                {
                                    <Text selectable={true} style={[stylesFont.fontNolanBold, { marginLeft: _moderateScale(8 * 1), fontSize: _moderateScale(15), color: '#EF9000' }]}>
                ...
                <View style={[styleElement.rowAliTop, { paddingHorizontal: _moderateScale(8 * 3), marginTop: _moderateScale(8 * 2) }]}>
                    ...
                    {/* <View style={{ flex: 1 }}>
                        <View style={[styleElement.rowAliCenter, { justifyContent: 'space-between' }]}>
                            <TouchableOpacity
                                onPress={_handleOpenModalCashIn}
                                style={[styleElement.rowAliCenter, { paddingHorizontal: _moderateScale(8), paddingVertical: _moderateScale(4), borderWidth: _moderateScale(0.5), borderColor: WHITE, borderRadius: _moderateScale(4) }]}>
