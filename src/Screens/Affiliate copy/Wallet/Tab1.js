...
import { getListOrderCommission } from '../../../Redux/Action/Affiilate';
...
const Tab1 = memo((props) => {
    ...
    useEffect(() => {
        ...
        _getListOrderCommission(props?.currMonthFilter, props?.currLevelFilter)
    }, [props?.currMonthFilter, props?.currLevelFilter])

    const _getListOrderCommission = async (currMonthFilter, currLevelFilter) => {
        setIsLoading(true)
        ...
        let result = await getListOrderCommission({
                                                        ...
                                                        <View style={{ flex: 4 }}>
                                                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                                                <Text
                                                                    ...
                                                                    {index + 1}. {item?.order?.partner?.name}
                                                                </Text>
