...
import { GREY, WHITE, GREEN_SUCCESS, BLUE, BLUE_FB, BLACK, THIRD_COLOR, SECOND_COLOR, FOURTH_COLOR, BASE_COLOR, BG_GREY_OPACITY_5, TITLE_GREY, BTN_PRICE, RED, BG_BEAUTY, BLACK_OPACITY_8, PRICE_ORANGE, BG_GREY_OPACITY_3, BLACK_OPACITY_7, BG_GREY_OPACITY_2, BG_GREY_OPACITY_7 } from '../../Constant/Color';
...
const DetailServiceFlashSale = (props) => {
    ...
    const _handleOnpressBooking = () => {
        ...
        if (props?.route?.params?.servicePromotion?.usage == props?.route?.params?.servicePromotion?.limit) {
        ...
        navigation.navigate(ScreenKey.CREATE_BOOKING_FLASH_SALE, {
            choiceService: props?.route?.params?.choiceService
        })
    }
            ...
            <Animated.ScrollView
                ...
                <View style={{
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        <Text style={[stylesFont.fontDinTextProBold, styles.price, { textDecorationLine: 'line-through', color: BG_GREY_OPACITY_7 }]}>
                            {formatMonney(currentService?.price)}
                        </Text>
                        <Text style={{ top: -_moderateScale(4), marginLeft: _moderateScale(4), ...stylesFont.fontNolanBold, color: BG_GREY_OPACITY_7, fontSize: _moderateScale(20), }}>đ</Text>
                    </View>
                    <View style={{ flexDirection: 'row'}}>
                        <Text style={[stylesFont.fontDinTextProBold, styles.price, { color: RED }]}>
                            {formatMonney(props?.route?.params?.choiceService?.finalPrice)}
                        </Text>
                        <Text style={{ top: -_moderateScale(4), marginLeft: _moderateScale(4), ...stylesFont.fontNolanBold, color: RED, fontSize: _moderateScale(20), }}>đ</Text>
                    </View>
...
export default DetailServiceFlashSale;