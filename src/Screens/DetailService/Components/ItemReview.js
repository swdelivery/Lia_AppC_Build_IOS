...
const ItemReview = memo((props) => {
        ...
        switch (type) {
                ...
                return <View style={[styles.statusOfPartner]}>
                    <Text style={{color: BG_GREY_OPACITY_9  }}>| </Text>
                            ...
                            <Text style={[stylesFont.fontNolan, 
                                {marginLeft: _moderateScale(4), color: BLUE_FB,fontSize: _moderateScale(12)}]}>Tuyệt vời</Text>
                        </View>
                break;
            ...
            case 'NOT_GOOD':
                return <View style={[styles.statusOfPartner]}>
                            ...
                            />
                            <Text style={[stylesFont.fontNolan, 
                                {marginLeft: _moderateScale(4), color: BLUE_FB,fontSize: _moderateScale(12)}]}>Tạm ổn</Text>
                        </View>
                break;
            ...
            case 'BAD':
                return <View style={[styles.statusOfPartner]}>
                    <Text style={{color: BG_GREY_OPACITY_9  }}>| </Text>
                            ...
                            />
                            <Text style={[stylesFont.fontNolan, 
                                {marginLeft: _moderateScale(4), color: GREY,fontSize: _moderateScale(12)}]}>Chưa hài lòng</Text>
                        </View>
                break;
    ...
    return (
        <TouchableOpacity disabled style={[styles.btnReview]}>
            <Image
                style={[styles.avatar]}
                source={{
