...
const AnimatedProcedure = memo((props) => {
    ...
    return (
        <>
            ...
            <View style={{ paddingHorizontal: _moderateScale(8 * 1) }}>
                <Collapsible collapsedHeight={_heightScale(170)} collapsed={collapsedTab1}>
                    <View style={{ paddingHorizontal: _moderateScale(8) }}>
                        {
                            props?._renderParameterDescription(props?.currentService?.procedureDescription)
                        }
                    </View>
                </Collapsible>
...
export default AnimatedProcedure;