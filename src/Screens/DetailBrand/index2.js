                    ...
                    <View style={styles.bannerProfile}>
                        <TouchableOpacity onPress={() => {
                            ...
                            <FastImage
                                ...
                                uri={currentBranch?.representationFileArr[0]?.link ? `${URL_ORIGINAL}${currentBranch?.representationFileArr[0]?.link}` : URL_AVATAR_DEFAULT}
                            />
                        </TouchableOpacity>
                        <View style={styles.bannerProfile__nameAndJob}>

                            <Text numberOfLines={1} style={[stylesFont.fontNolanBold, styles.bannerProfile__nameAndJob__name]}>
                                {
                                    `${currentBranch?.name}`
                                }
                            </Text>
                            <View style={[styleElement.rowAliCenter]}>
                                ...
                                />
                                <Text  numberOfLines={1} style={[stylesFont.fontNolan500, styles.bannerProfile__nameAndJob__job,
                            ...
                            <View style={[styleElement.rowAliCenter]}>
                                ...
                                />
                                <Text numberOfLines={2} style={[stylesFont.fontNolan500, styles.bannerProfile__nameAndJob__job,
