...
import { BLUE_FB, GREY, WHITE } from '../../Constant/Color';
        ...
        <View style={styles.container}>
            ...
            <Animated.ScrollView
                ...
                <View style={{
                    ...
                    <Text style={[stylesFont.fontNolan500,{fontSize:_moderateScale(18), alignSelf:'center', marginTop:_moderateScale(8*3), color:GREY}]}>
