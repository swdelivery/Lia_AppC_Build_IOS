...
const AddMemberToGroupChat = memo((props) => {
    ...
    const _confirmAddMembersToGroupChat = async () => {
        ...
        let resultAddMembersToGroupChat = await handleApi(_addMembersToGroupChat({
    ...
    const _renderItemMember = ({ item, index }) => {
        ...
        return (
            <View style={[styleElement.rowAliCenter, { flex: 1 }, index == membersRedux.listMembersOfSystem.length - 1 && { marginBottom: _moderateScale(8 * 6) }]}>
                <Image
                    style={{
    ...
    return (
        <View style={{ flex: 1, backgroundColor: Color.WHITE }}>
            ...
            <View style={{ width: _width, paddingHorizontal: _moderateScale(14), marginVertical: _moderateScale(16) }}>
