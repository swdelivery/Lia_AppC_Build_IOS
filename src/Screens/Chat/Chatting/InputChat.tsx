...
const InputChat = memo((props) => {
        ...
        moment
          .duration(
            moment(new Date()).diff(
              moment(infoCurrRoomChattingRedux?.latestMessage?.created)
            )
          )
          .asMinutes() > 60
      ) {
  ...
  const Suggestions = ({} = ({ keyword, onSelect }) => {
    if (keyword == null) {
      return null;
    }
        ...
        {isShowlistSgMsg ? (
          <View
            style={{
              ...
              paddingTop: 8,
              backgroundColor: Color.WHITE,
              borderTopStartRadius: 8 * 2,
              borderTopEndRadius: 8 * 2,
            }}
          >
            <FlatList
              ListHeaderComponent={<View style={{ height: 8 * 2 }} />}
              ...
              ListFooterComponent={<View style={{ height: 8 * 2 }} />}
      ...
      >
        <View style={[styleElement.rowAliCenter]}>
          ...
          <TouchableOpacity
            onPress={() => {
              ...
              console.log(
                "tuccccccccccccccccccccccccccccccccccccccccccccccc",
                data
              );
        ...
        <View>
          ...
          >
            {loadingSendMessage ? (
              <ActivityIndicator
                color={Platform.OS !== "ios" && Color.GREY}
                size={"small"}
              />
            ) : (
              <Image
