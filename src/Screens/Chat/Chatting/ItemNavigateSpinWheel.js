...
const ItemNavigateSpinWheel = memo((props) => {
                        ...
                        <>
                            <View style={{
                                ...
                                <TouchableOpacity
                                    ...
                                    style={[styles.btnSeeInfo, { backgroundColor: Color.BASE_COLOR, flexDirection: 'row', alignItems: 'center' }]}>
...
export default ItemNavigateSpinWheel;