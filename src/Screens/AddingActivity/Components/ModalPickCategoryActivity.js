...
const ModalPickCategoryActivity = memo((props) => {
            ...
            >
                <View style={styles.container}>
                    ...
                    <View style={styles.backAndTitle}>
                        ...
                        <Text style={[stylesFont.fontNolan500, { fontSize: _moderateScale(16) }]}>Chọn danh mục hoạt động</Text>
...
export default ModalPickCategoryActivity;