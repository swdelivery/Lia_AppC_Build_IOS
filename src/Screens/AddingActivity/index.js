...
const index = memo((props) => {
  ...
  const _handleConfirmCreateActivity = async (dataForCreate) => {
    ...
    if (dataForCreate?.representationFileIdArr?.length > 0) {
      dataForCreate = {
        ...dataForCreate,
        representationFileIdArr: dataForCreate?.representationFileIdArr?.map(
          (item) => item?._id
        ),
      };
    }
    ...
    let resultAfterConvertNum = convertNumberInObject(dataForCreate, [
      "calo",
      "minutes",
    ]);
      ...
      <ScrollView scrollIndicatorInsets={{ right: 1 }}>
        ...
        >
          <Text
            style={[
              ...
              { fontSize: _moderateScale(16), color: BLACK_OPACITY_8 },
            ]}
          >
            Danh mục
          </Text>
          ...
          >
            <Image
              style={[sizeIcon.sm]}
              source={require("../../Icon/whitePlus2.png")}
            />
          </TouchableOpacity>
        </View>
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              ...
              <TextInput
                ...
                onChangeText={(value) =>
                  parseNumberSetFieldValue("name", value)
                }
              ...
              values?.representationFileIdArr?.length > 0 ? (
                ...
                >
                  <Image
                    ...
                    source={{
                      uri: `${URL_ORIGINAL}${values?.representationFileIdArr[0]?.link}`,
                    }}
                  />
                </TouchableOpacity>
              ) : (
        ...
        >
          <View style={{ flex: 1, marginRight: _moderateScale(8 * 2) }}>
            ...
            >
              Thời gian (phút) {<Text style={{ color: RED }}>*</Text>}
            </Text>
            <TextInput
              keyboardType={"numbers-and-punctuation"}
              onFocus={() => setFieldTouched("minutes")}
              onChangeText={(value) =>
                parseNumberSetFieldValue("minutes", value)
              }
              style={[stylesFont.fontNolan, styles.input]}
              placeholder={"vd: 30"}
            />
          ...
          <View style={{ flex: 1 }}>
            ...
            >
              Năng lượng đốt (kcal) {<Text style={{ color: RED }}>*</Text>}
            </Text>
            <TextInput
              keyboardType={"numbers-and-punctuation"}
        ...
        >
          <Text
            style={[
              stylesFont.fontNolan500,
              { fontSize: _moderateScale(14), flex: 1, color: GREY_FOR_TITLE },
            ]}
          >
            Ghi chú
          </Text>
          ...
          >
            <TextInput
              onChangeText={(value) =>
                parseNumberSetFieldValue("description", value)
              }
