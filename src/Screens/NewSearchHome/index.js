...
import { BASE_COLOR, BG_GREY_OPACITY_5, BG_GREY_OPACITY_9, BLACK_OPACITY_8, GREY, RED, WHITE } from '../../Constant/Color'
import RecentFind from './Components/RecentFind'
import { getDataSuggestionSearch, getServicev2 } from '../../Redux/Action/Service'
...
const NewSearchHome = memo((props) => {
    ...
    const _pressSearch = async (key) => {
        ...
        let listHistorySearchKey = JSON.parse(await AsyncStorage.getItem('listHistorySearchKey'))
        // listHistorySearchKey.push(`${key}`)
        ...
        AsyncStorage.setItem('listHistorySearchKey', JSON.stringify(listHistorySearchKey))
    ...
    return (
        <View style={styles.container}>
            ...
            <Header pressSearch={_pressSearch} setKeySearch={setKeySearch} value={keySearch} onchangeText={_handleOnchangeSearch} />
                        ...
                        listSG?.map((item, index) => {
                            return (
                                <TouchableOpacity
                                    ...
                                    <Text style={[stylesFont.fontNolanBold, { fontSize: _moderateScale(12), color: WHITE }]}>
                                        {
                                            item?.content
                                        }
                                    </Text>
...

            {
                showResult ?
                    ...
                    <ScrollView>
                        <View style={{}}>
                            <RecentFind setKeySearch={setKeySearch} pressSearch={_pressSearch} />
                        </View>
                    </ScrollView>
            }
        </View>
