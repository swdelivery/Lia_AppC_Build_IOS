        ...
        <View>
            <View style={{
                ...
                <View style={styles.overView__box__leftEye}>
                    <Image
                        ...
                        source={{ uri: `https://i.ibb.co/qgdb2yr/Kho-ng-co-tie-u-e.jpg` }} />
                </View>
            ...
            <View style={{
                ...
                <Text style={{ color: GREY_FOR_TITLE, fontWeight: 'bold' }}>
                    Hoàn tất quá trình quét mắt trái
                </Text>
                ...
                <View style={{ paddingHorizontal: _moderateScale(8 * 1.5) }}>
                    <View style={{
                        ...
                        <Image
                            ...
                            source={{ uri: `https://i.ibb.co/VqmSBxF/bong-mat.png` }} />
                    ...
                    <View style={{
                        ...
                        <Image
                            ...
                            source={{ uri: `https://i.ibb.co/Jq8kqfQ/hoc-mat.png` }} />
                        <View style={{ flex: 1, paddingLeft: _moderateScale(8) }}>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                <View style={{ flex: 1 }}>
                                    <Text style={{
