...
const ListNews = () => {
    ...
    const listNewsRedux = useSelector(state => state?.newsReducer?.listNews)
    ...
    useEffect(() => {
        if (listCategory.length > 0) {
            setCurrentGroup(listCategory[0].code)
        }
    }, [listCategory])
    ...
    useEffect(() => {
        if (currentGroup !== '') {
            ...
            dispatch(getAllNews(condition,'listnews'))
        }
    }, [currentGroup])
                ...
                <Animated.Image
                    ...
                    <View style={{
                                    ...
                                    listCategory.map((item, index) => {
                                        return (
                                            <TouchableOpacity
                                                ...
                                                style={[styles.itemCate, item?.code === currentGroup && styles.itemCateActive ]} key={index} >
                                             
                                                    <Text style={[styles.nameCategory, item?.code === currentGroup && styles.nameCategoryActive]}>
                                                        {item.name}
                                                    </Text>
                                            </TouchableOpacity>
                                        )
                        ...
                        <Text style={{
                            ...
                            {find(listCategory, { code: currentGroup })?.name}
                        </Text>
