...
const BookingView = memo((props) => {
    ...
    const [branchMain, setBranchMain] = useState(null)
    ...
    return (
        <>
            ...
            <View style={[styleElement.rowAliCenter, { paddingHorizontal: _moderateScale(8 * 2), flex: 1, marginTop: _moderateScale(24) }]}>
                <TextInput
                    onChangeText={(e) => setCodeRef(e)}
                    value={codeRef}
                    style={[styles.inputCodeRef, { flex: 1 }]} placeholder={"vd: AF209BHN"} />
            ...
            <View style={[styles.rowContent,{marginBottom: _moderateScale(8)}]}>
                <ScrollView
                    ...
                    <View style={[styles.listBranch]}>
                        {
                            listBranchRedux?.map((item, index) => {
                                if (item?.code == branchForBooking) {
                                    return (
                                        <TouchableOpacity
                                            key={index}
                                            style={[styles.itemBranch, branchForBooking, styles.itemBranchActive]}>
                                            <Text style={[styles.titItemBranch, stylesFont.fontNolanBold]}>{item?.name}</Text>
                                        </TouchableOpacity>
                                    )
                                }
                                return (
           ...
           {!_isEmpty(branchMain)?<><View style={[styleElement.rowAliCenter,{
                ...
                <Text style={[stylesFont.fontNolan500,
                    { opacity: 1,fontStyle:'italic', color:Color.GREY_FOR_TITLE, paddingLeft: _moderateScale(4) }]}>
                    {
                    `${branchMain?.phone} `
                    }
                </Text>
            ...
            <View style={[styles.rowContent, {flexDirection: 'column', marginBottom: _moderateScale(16)}]}>
            <TouchableOpacity 
                style={{
                borderWidth: 0.5,
                alignItems:'center',
                ...
                onPress={() => {
                    ...
                    <Text style={[stylesFont.fontNolanBold, 
                        {marginLeft:_moderateScale(8),
                         fontSize: _moderateScale(14), color: currPickDate? WHITE:Color.BLUE_FB, }]}>
                        {
                            currPickDate ?
                                moment(currPickDate).format('DD/MM/YYYY')
                                :
            ...
            <View style={[styles.rowContent,{marginTop:_moderateScale(8), marginBottom:_moderateScale(8*2)}]}>
                <ScrollView
                    // contentContainerStyle={{flex: 1 }}
                    showsHorizontalScrollIndicator={false}
                    horizontal={true}>
                    <View style={[styles.listService]}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[styles.itemService, { justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderStyle: 'dashed' }]}>
