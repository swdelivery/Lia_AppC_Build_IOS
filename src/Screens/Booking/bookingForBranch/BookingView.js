...
const BookingView = memo((props) => {
    ...
    useEffect(() => {
        ...
        if (props?.infoServiceToCreateBooking) {
            setListServiceHasChoice(old => [...old, props?.infoServiceToCreateBooking])
        }

    }, [props?.infoServiceToCreateBooking])
    ...
    const _handleConfirmCreateBooking = async () => {
        ...
        console.log({ codeRef, branchMain, currTimeChoice, listServiceHasChoice, description, currPickDate })

        if (_isEmpty(branchMain) || !currPickDate || _isEmpty(currTimeChoice) || _isEmpty(listServiceHasChoice)) {
                                ...
                                return (
                                    ...
                                    <View style={[{
                                        ...
                                        <ImageBackground
                                            ...
                                            imageStyle={{ borderWidth: 1, borderRadius: _moderateScale(8), borderColor: Color.BG_GREY_OPACITY_2, backgroundColor: Color.BG_GREY_OPACITY_2, }}
                                            source={{
