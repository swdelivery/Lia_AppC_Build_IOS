...
const BookingView = memo((props) => {
  ...
  useEffect(() => {
    if (props?.dataBooking?._id) {
      ...
      setCurrPickDate(
        moment(props?.dataBooking?.appointmentDateFinal?.date).format()
      );
  ...
  const _handleConfirmCreateBooking = async () => {
    ...
    let resultCreateNewBooking = await updateBooking(
      dataFetchCreateBooking,
      props?.dataBooking?._id
    );
    ...
    <>
      ...
      >
        <TextInput
          ...
          style={[
            styles.inputCodeRef,
            { flex: 1, marginHorizontal: _moderateScale(8 * 2) },
          ]}
          ...
          >
            {props?.infoDoctor?.avatar?.link ? (
              <Image
                ...
                source={{
                  uri: `${URL_ORIGINAL}${props?.infoDoctor?.avatar?.link}`,
                }}
              />
            ) : (
              <View
            ...
            <View style={{ marginLeft: _moderateScale(8) }}>
              ...
              >
                <CountStar
                  reviewCount={props?.infoDoctor?.reviewCount}
                  averageRating={parseInt(props?.infoDoctor?.averageRating)}
                  small
                />
                ...
                >
                  <Image
                    style={sizeIcon.xxs}
                    source={require("../../../NewIcon/people.png")}
                  />
                  <Text
                    style={{
                      ...stylesFont.fontNolan500,
      ...
      <View
        style={[
          { marginTop: _moderateScale(0), marginBottom: _moderateScale(8 * 1) },
        ]}
      >
                  ...
                  >
                    ...
                    >
                      <CountStar
                        ...
                        averageRating={parseInt(item?.averageRating)}
                        small
                      />
