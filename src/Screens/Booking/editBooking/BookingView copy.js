...
import { getListBranchLocation, createNewBooking, getListDoctorLocation } from '../../../Redux/Action/BookingAction'
...
const BookingView = memo((props) => {
    ...
    return (
        <>
            ...
            <View style={[styles.rowContent,{marginBottom:_moderateScale(16) ,flexDirection:'column'}]}>
                <ScrollView
            ...
            <View style={[styles.rowContent, {flexDirection:'column', marginTop: _moderateScale(16)}]}>
            <TouchableOpacity 
                style={{
                borderWidth: 0.5,
                alignItems:'center',
