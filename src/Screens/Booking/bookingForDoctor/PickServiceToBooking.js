...
import {
  getListServiceForBooking,
  getAllServiceByGroupId,
...
import { URL_ORIGINAL, URL_ORIGINAL } from "../../../Constant/Url";
...
const PickServiceToBooking = memo((props) => {
  ...
  const _handleChoiceFileService = (itemProp) => {
    if (listServiceHasChoice?.find((item) => item?._id == itemProp?._id)) {
      setListServiceHasChoice((olds) =>
        [...olds].filter((item) => item?._id !== itemProp?._id)
      );
    } else {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <Text
          style={[
            ...
            { marginLeft: _moderateScale(8 * 2), fontSize: _moderateScale(14) },
          ]}
        >
          CHỌN DỊCH VỤ
        </Text>
        ...
        <View style={{ paddingBottom: _moderateScale(8) }}>
          ...
          >
            <TouchableOpacity
              ...
              style={[
                styles.btnNotActive,
                currChoiceFolder == "all" && styles.btnActive,
              ]}
            >
              <Text
                style={[
                  stylesFont.fontNolan500,
                  { fontSize: _moderateScale(14), color: BLACK_OPACITY_8 },
                  currChoiceFolder == "all" && { color: WHITE },
                ]}
              >
                Tất cả
              </Text>
            ...
            {!_isEmpty(listServiceForBooking) &&
              listServiceForBooking?.map((item, index) => {
                return (
                  <TouchableOpacity
                    key={index}
                    ...
                    style={[
                      styles.btnNotActive,
                      currChoiceFolder?._id == item?._id && styles.btnActive,
                    ]}
                  >
                    <Text
                      style={[
                        ...
                        currChoiceFolder?._id == item?._id && { color: WHITE },
                      ]}
                    >
                      {item?.name}
                    </Text>
      ...
      {!_isEmpty(listServiceAfterFilter) ? (
          ...
          {listServiceAfterFilter?.map((item, index) => {
            return (
              <View
                style={[
                  styles.itemService,
                  index % 2 == 0 && { marginRight: _moderateScale(8) },
                ]}
              >
                <Image
                  style={[
        ...
        >
          <Text
            style={[
              stylesFont.fontNolan500,
              { color: BLACK_OPACITY_8, fontSize: _moderateScale(14) },
            ]}
          >
      ...
      <TouchableOpacity onPress={_handleConfirm} style={styles.btnConfirm}>
        <Text
          style={[
            stylesFont.fontNolan500,
