            ...
            <Animated.ScrollView
                ...
                <View style={{
                    ...
                    <KeyboardAwareScrollView>
                        <BookingView infoBranch={props?.route?.params?.infoBranch} infoDoctor={props?.route?.params?.infoDoctor}  branchCode={props?.route?.params?.branchCode} doctorCode={props?.route?.params?.doctorCode}/>
                    </KeyboardAwareScrollView>
