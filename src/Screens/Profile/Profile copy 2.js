        ...
        <View style={styles.container}>
            ...
            {/* {refresh ?
                <View style={{
                    ...
                    <ActivityIndicator size="small" color={BASE_COLOR} />
                    <Text style={{ fontSize: _moderateScale(14), color: GREY_FOR_TITLE, marginLeft: _moderateScale(8) }}>Đang cập nhật dữ liệu ...</Text>
                </View>
                : <></>} */}
            <Animated.ScrollView
                ...
                <View style={{
                    backgroundColor: WHITE,
                    flex: 1,
                    // paddingBottom: _moderateScale(8 * 10),
                    ...
                    <View style={[styles.bannerPatient, shadow, { paddingVertical: 0, marginTop: 200 }]}>
                        <TouchableOpacity
                        ...
                        <View style={[styleElement.lineHorizontal]} />
                        <TouchableOpacity
                            onPress={() => navigation.navigate(ScreenKey.LIST_DEPOSIT)}
                            style={[styleElement.rowAliCenter, { paddingVertical: _moderateScale(8 * 2) }]}>
                            <Text style={[stylesFont.fontNolan500, { flex: 1, color: BLACK_OPACITY_8, fontSize: _moderateScale(14) }]}>
                                Tiền cọc
                                </Text>
                        ...
                        <View style={[styleElement.lineHorizontal]} />
                        <TouchableOpacity
                            onPress={() => navigation.navigate(ScreenKey.LIST_DEPOSIT_REQUEST)}
                            style={[styleElement.rowAliCenter, { paddingVertical: _moderateScale(8 * 2) }]}>
                            <Text style={[stylesFont.fontNolan500, { flex: 1, color: BLACK_OPACITY_8, fontSize: _moderateScale(14) }]}>
                                Yêu cầu nạp / rút
                                </Text>
                        ...
                        <View style={[styleElement.lineHorizontal]} />
                        <TouchableOpacity
                            onPress={() => navigation.navigate(ScreenKey.LIST_PAYMENT)}
                            style={[styleElement.rowAliCenter, { paddingVertical: _moderateScale(8 * 2) }]}>
                            <Text style={[stylesFont.fontNolan500, { flex: 1, color: BLACK_OPACITY_8, fontSize: _moderateScale(14) }]}>
                                Tiền thanh toán
                                </Text>
 ...
 */}
                    ...
                    {/* <TouchableOpacity
                        ...
                        style={{ alignItems: 'center', marginTop: _moderateScale(8 * 2), alignSelf: 'center' }}>
