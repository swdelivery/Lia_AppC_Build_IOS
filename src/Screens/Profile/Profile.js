...
const Profile = (props) => {
  ...
  const medicalPrescriptionRedux = useSelector(
    (state) => state?.infoReducer?.medicalPrescription
  );
  const treatmentDetailRedux = useSelector(
    (state) => state?.infoReducer?.treatmentDetail
  );
  ...
  const _getPartnerLevel = async () => {
    ...
    let partnerSilver = result?.data?.data?.find(
      (item) => item?.code == "SILVER"
    );
    if (partnerSilver) {
    ...
    let partnerPlatium = result?.data?.data?.find(
      (item) => item?.code == "PLATINUM"
    );
    if (partnerPlatium) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ModalPickSingleNotSearch
        ...
        data={showModalListCourse?.data}
        show={showModalListCourse?.show}
      />
          ...
          >
            ...
            >
              ...
              >
                <Image
                  style={[sizeIcon.llg]}
                  source={require("../../NewIcon/settingWhite.png")}
                />
              </TouchableOpacity>
            </View>
            <View
              ...
              >
                ...
                >
                  ...
                  <View style={{ marginLeft: _moderateScale(8), flex: 1 }}>
                    ...
                    >
                      {formatMonney(
                        parseInt(infoUserRedux?.infoUser?.liaPoint / 1000)
                      )}{" "}
                      điểm
                    </Text>
                  </View>
                    ...
                    >
                      ...
                      <View
                        style={{
                          ...
                          backgroundColor: BG_GREY_OPACITY_9,
                        }}
                      >
                        <View
                          style={{
                            width: _moderateScale(
                              (230 * infoUserRedux?.infoUser?.liaPoint) /
                                partnerGold?.promotionCondition?.revenue
                            ),
                            height: _moderateScale(4),
            ...
            >
              ...
              >
                <Image
                  ...
                  source={require("../../NewIcon/coinBags.png")}
                />
              </View>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  style={sizeIcon.lg}
                  source={require("../../NewIcon/voucherBlue.png")}
                />
              </View>
              <View style={{ flex: 1, marginLeft: _moderateScale(8) }}>
                <Text
        ...
        >
          ...
          <View
            style={[
              ...
              {
                justifyContent: "space-between",
                paddingHorizontal: _moderateScale(8 * 5),
          ...
          >
            ...
            >
              <Image
                style={sizeIcon.lxlg}
                source={require("../../NewIcon/peopleBlue.png")}
              />
              <Text
                style={{
                  ...stylesFont.fontNolan500,
            ...
            >
              <Image
                style={sizeIcon.lxlg}
                source={require("../../NewIcon/heart.png")}
              />
              <Text
                style={{
                  ...stylesFont.fontNolan500,
            ...
            >
              <Image
                style={sizeIcon.lxlg}
                source={require("../../NewIcon/diary.png")}
              />
              <Text
                style={{
                  ...stylesFont.fontNolan500,
          ...
          >
            ...
            >
              <Image
                style={sizeIcon.md}
                source={require("../../NewIcon/calendarBase.png")}
              />
            </View>
            <Text
              style={{
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate(ScreenKey.PURCHASE_DEPOSIT_REQUEST)
            }
            style={{
              paddingVertical: _moderateScale(8 * 2),
              paddingHorizontal: _moderateScale(8 * 3),
          ...
          >
            ...
            >
              <Image
                style={sizeIcon.md}
                source={require("../../NewIcon/dollarBase.png")}
              />
            </View>
            <Text
              style={{
          ...
          >
            ...
            >
              <Image
                style={sizeIcon.md}
                source={require("../../NewIcon/serviceBase.png")}
              />
            </View>
            <Text
              style={{
          ...
          >
            ...
            >
              <Image
                style={sizeIcon.md}
                source={require("../../NewIcon/medicine.png")}
              />
            </View>
            <Text
              style={{
