...
import { BASE_COLOR, BG_GREY_OPACITY_3, BG_GREY_OPACITY_7, BG_GREY_OPACITY_9, BLUE, BLUE_2, BLUE_FB, GREEN_2, GREEN_SUCCESS, GREY, GREY_FOR_TITLE, SECOND_COLOR, THIRD_COLOR, WHITE } from '../../../Constant/Color';
        ...
        <ModalInfoTreatmentDetail
                ...
                <View style={[styles.rightService]}>
                    ...
                    <View  style={[styles.bottomService]}>
                        ...
                        style={{marginRight: _moderateScale(8), backgroundColor:SECOND_COLOR,
