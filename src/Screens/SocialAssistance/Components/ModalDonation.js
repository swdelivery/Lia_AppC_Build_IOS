...
import { createPaymentRequestForSocialProject } from "../../../Redux/Action/SocialAssistanceAction";
import { getConfigData } from "../../../Redux/Action/OrtherAction";
import TextInput from "@Components/TextInput";

const ModalDonation = memo((props) => {
  ...
  const _handleConfirmCreatePaymentRequest = async () => {
    if (currTab == "1") {
      ...
      let dataFetchCreatePaymentRequest = {
        ...
        socialProjectId: props?.socialProjectId,
      };

      let resultCreatePaymentRequest =
        await createPaymentRequestForSocialProject(
            ...
            <View style={{ height: _moderateScale(8 * 32) }}>
              ...
              <TextInput
                ...
                style={[
                  stylesFont.fontNolanBold,
                  styles.inputDeposit,
                  { color: BLUE_FB, marginTop: _moderateScale(8) },
                ]}
