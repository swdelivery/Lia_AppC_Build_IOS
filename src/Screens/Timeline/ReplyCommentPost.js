    ...
    return (
      <View style={[styles.comment]}>
        <Image
          ...
          source={{
            uri: item?.userCreate?.profile?.fileAvatar?.link
              ? `${URL_ORIGINAL}${item?.userCreate?.profile?.fileAvatar?.link}`
              : URL_AVATAR_DEFAULT,
          }}
        />
        <View style={{ flex: 1, marginLeft: _moderateScale(8 * 0.5) }}>
          <View style={styles.comment__nameAndContent}>
            <Text
              style={[
                ...
                styles.comment__nameAndContent__name,
              ]}
            >
            ...
            <Text
              style={[
                ...
                styles.comment__nameAndContent__content,
              ]}
            >
              {item.content}
            </Text>
          ...
          >
            <Text
              style={[
                stylesFont.fontNolan,
                { fontSize: _moderateScale(12), color: GREY },
              ]}
            >
