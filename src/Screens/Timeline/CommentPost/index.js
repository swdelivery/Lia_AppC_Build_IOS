...
import { clearCurrSeePost, confirmCommentPost, getAllCommentsByPost } from '../../../Redux/Action/PostAction';
    ...
    return (
        ...
        <KeyboardAvoidingView keyboardVerticalOffset={Platform.OS == 'ios' && getBottomSpace() == 0 ? _heightScale(16) : 0} behavior={Platform.OS == 'ios' ? 'padding' : null} style={{
            ...
            <View style={[styles.container]}>
                ...
                <HeaderAndAvatar
                    data={props?.route?.params?.data}
                    avatar={props?.route?.params?.data?.userCreate?.profile?.fileAvatar?.link} />
                {/* <ScrollView> */}
