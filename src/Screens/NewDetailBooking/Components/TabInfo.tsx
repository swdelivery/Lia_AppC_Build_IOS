...
import { BASE_COLOR, BLACK, BLUE_FB, BORDER_COLOR, GREY, RED, WHITE } from '@Constant/Color'
                        ...
                        listStatus?.map((item, index) => {
                            ...
                            if (item?.time) {
                                return (
                                    <View>
                                        <Row gap={8}>
                                            <View style={[styles.dotNumber, { backgroundColor: BASE_COLOR }]}>
                                                <Text weight='bold' color={WHITE}>
                                                    {index + 1}
                                                </Text>
                                            </View>
                                            <Text style={styleElement.flex} weight='bold' color={BASE_COLOR}>
                                                {item?.name}
                                            </Text>
