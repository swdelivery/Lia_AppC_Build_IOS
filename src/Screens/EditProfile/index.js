...
const EditProfile = (props) => {
  ...
  const _handleChangeInputEmail = (val) => {
    setInfoUser((old) => {
      return {
        ...old,
        email: [val, ...old.email.filter((item, ind) => ind > 0)],
      };
    });
  };
      ...
      >
              ...
              <View style={styles.bannerProfile}>
                      ...
                      <FastImage
                        ...
                        uri={
                          infoUserRedux?.fileAvatar?.link
                            ? `${URL_ORIGINAL}${infoUserRedux?.fileAvatar?.link}`
                            : URL_AVATAR_DEFAULT
                        }
                      />
                    )}
                ...
                <View style={styles.bannerProfile__nameAndJob}>
                  ...
                  <View style={[styles.ranking]}>
                    ...
                    >
                      {
                        find(partnerLevel, { code: infoUserRedux?.levelCode })
                          ?.name
                      }
                    </Text>
                  </View>
...

        {
          !infoUserRedux?.fileAvatar?.link ? (
            ...
            <ImageView
              images={[`${URL_ORIGINAL}${infoUserRedux?.fileAvatar?.link}`].map(
                (item) => {
                  return {
                    uri: item,
                  };
        ...
        >
          ...
          <View style={styles.absoluteTitle}>
            <Image
              style={[sizeIcon.lg, { marginRight: _moderateScale(16) }]}
              source={require("../../NewIcon/user.png")}
            />
            ...
            <View style={[styles.main]}>
              ...
              <View style={[styles.rowContent]}>
                <TextInput
                  ...
                  style={[
                    styles.inputElement,
                    { ...stylesFont.fontNolan500, color: BLUE_FB },
                  ]}
                />
              </View>
              ...
              <View style={[styles.containTitle]}>
                <Text
                  type="number"
                  style={[stylesFont.fontNolanBold, styles.titleMain]}
                >
                  Điện thoại:
                </Text>
              </View>
              <View style={[styles.rowContent]}>
                <TextInput
                  value={`${infoUserRedux?.fullPhone[0]}`}
                  style={[
                    styles.inputElement,
                    styles.inputDisableElement,
                    { ...stylesFont.fontNolan500, color: BLUE_FB },
                  ]}
                  editable={false}
              ...
              <View style={[styles.rowContent]}>
                <TextInput
                  value={
                    infoUser?.address?.length > 0
                      ? infoUser?.address[0]?.fullAddress
                      : ""
                  }
                  onChangeText={(value) => {
                    _handleChangeInputAddress(value);
                  }}
                  placeholder={`434, Đường Cao thắng, Phường 12, Quận 10, Hồ Chí Minh`}
                  style={[
                    styles.inputElement,
                    { ...stylesFont.fontNolan500, color: BLUE_FB },
                  ]}
              ...
              <View style={[styles.rowContent]}>
                ...
                >
                  <Text
                    style={[
                      stylesFont.fontNolan500,
                      { fontSize: _moderateScale(14), color: GREY },
                    ]}
                  >
                    {infoUser?.birthday
              ...
              <View style={[styles.rowContent, styles.rowGender]}>
                <TouchableOpacity
                  onPress={() => _handleChangeInput("gender", "male")}
                >
                  <View
                    style={[
                      styles.btnGender,
                      infoUser?.gender === "male" ? styles.activeGender : "",
                    ]}
                  >
                    <Text
                      style={[
                        infoUser?.gender === "male"
                          ? styles.activeTxtGender
                          : "",
                      ]}
                    >
                      Nam
                ...
                <TouchableOpacity
                  onPress={() => _handleChangeInput("gender", "female")}
                >
                  <View
                    style={[
                      styles.btnGender,
                      infoUser?.gender === "female" ? styles.activeGender : "",
                    ]}
                  >
                    <Text
                      style={[
