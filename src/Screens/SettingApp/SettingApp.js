              ...
              <TouchableOpacity
                onPress={async () => {
                  ...
                  let result = await Permission.requestPermission(
                    REQUEST_PERMISSION_TYPE[PERMISSION_TYPE.microphone][
                      Platform.OS
                    ]
                  );
                  if (result == RESULTS.GRANTED) {
        ...
        >
          <View style={[styleElement.rowAliTop]}>
            <View style={{ flex: 1 }}>
              ...
              >
                Thư viện ảnh được sử dụng để gửi ảnh khi nhắn tin, cập nhật ảnh
                hậu phẫu
              </Text>
            </View>
        ...
        >
          <View style={[styleElement.rowAliTop]}>
            <View style={{ flex: 1 }}>
              ...
              >
                Camera được sử dụng để quét mã QR Code, nhắn tin bằng hình ảnh
                và tải ảnh hậu phẫu
              </Text>
            </View>
        ...
        <TouchableOpacity
          ...
          style={[
            styleElement.centerChild,
            {
              ...
              borderWidth: 1,
              marginHorizontal: _moderateScale(8 * 2),
              marginBottom: getBottomSpace() + _moderateScale(8 * 1),
            },
          ]}
        >
          <Text
