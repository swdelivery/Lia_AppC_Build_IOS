...
import { getAllServiceGroup, getServiceByGroup, newGetServiceByGroup, getServiceGroupv2 } from '../../Redux/Action/ServiceGroup';
...
const ListService = memo((props) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: Color.BG_BEAUTY_OPACITY_2, marginTop: _moderateScale(8 * 2) }}>
            ...
            <ModalPickSingleNotSearch
                ...
                data={listFilter} show={showModalPickFilter} />
            ...
            <View>
                <ScrollView showsHorizontalScrollIndicator={false} style={{ marginHorizontal: _moderateScale(8 * 2) }} contentContainerStyle={{ paddingRight: _moderateScale(8 * 2) }} horizontal>
                    <View style={{ flex: 5, flexDirection: 'row', paddingBottom: _moderateScale(4), paddingLeft: _moderateScale(8 * 1) }}>
                        <TouchableOpacity
                            onPress={() => {
                                setListChildGrActive([])
                            }}
                            style={[{ marginBottom: _moderateScale(4) }, styles.btnChildGr, listChildGrActive?.length == 0 && styles.btnChildGrActive]}>
                            <Text style={[styles.btnChildGr__text, listChildGrActive?.length == 0 && styles.btnChildGrActive__text]}>
                                Tất cả
                            </Text>
                        </TouchableOpacity>
                            ...
                            listChildGr?.map((item, index) => {
                                return (
                                    <TouchableOpacity
                                        ...
                                        style={[styles.btnChildGr, { marginBottom: _moderateScale(4) },
                                        listChildGrActive?.find(itemFind => itemFind?._id == item?._id) && styles.btnChildGrActive
                                        ]}>
                                        <Text style={[styles.btnChildGr__text,
                                        listChildGrActive?.find(itemFind => itemFind?._id == item?._id) && styles.btnChildGrActive__text
                                        ]}>
                                            {item?.name}
                                        </Text>
                                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={{ marginRight:_moderateScale(8*3), marginTop:_moderateScale(0)}}>
                        <Image style={[sizeIcon.lg]} source={require('../../Icon/filter_blue.png')}/>
                    </TouchableOpacity>
                </View> */}

                </ScrollView>
                <View style={{ paddingBottom: _moderateScale(8), paddingLeft: _moderateScale(8 * 3), alignItems: 'flex-end', paddingRight: _moderateScale(8 * 3) }}>
                    ...
                    <TouchableOpacity
                        ...
                        </Text>
                        {
                            currFilter?.flag == 'down' ?
                                <Image style={[sizeIcon.lg, { marginLeft: _moderateScale(4) }]} source={require('../../NewIcon/arrowDown.png')} />
                                : <></>
                        }
                        {
                            currFilter?.flag == 'up' ?
                                <Image style={[sizeIcon.lg, { marginLeft: _moderateScale(4) }]} source={require('../../NewIcon/arrowUp.png')} />
                                : <></>
                        }
                    </TouchableOpacity>
