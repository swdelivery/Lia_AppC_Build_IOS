...
import { getAllPost, getMoreAllPost, deletePost, getPartnerPostByIdUser } from '../../Redux/Action/PostAction';
...
const OtherListPosts = memo((props) => {
    ...
    const _openActionSheet = (idPost) => {
        ...
        // }, 0);
        navigation.navigate(ScreenKey.DETAIL_NEW_FEED, { idPost: idPost })
    }
