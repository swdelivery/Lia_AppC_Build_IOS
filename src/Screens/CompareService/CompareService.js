...
const CompareService = memo((props) => {
    ...
    const _getServiceProperties = async (listService) => {
        ...
        console.log({ listKey, listServiceTemp })
                            ...
                            renderItem={({ item, index }) => {
                                return (
                                    <View style={{
                                        ...
                                        justifyContent: 'center',
                                        paddingHorizontal: _moderateScale(4),
                                        backgroundColor: 'rgba(7, 140, 127,0.4)'
                                    ...
                                    <View
                                        ...
                                        <View style={{
                                            ...
                                            <TouchableOpacity
                                                onPress={() => {
                                                    // console.log({item});
                                                    navigation.push(ScreenKey.DETAIL_SERVICE,{idService: item?.info?._id})
                                                }}
                                                style={[styleElement.centerChild, {
                                                    ...
                                                    borderBottomWidth: 1,
                                                    borderBottomColor: Color.BLUE_FB
                                                }]}>
                                                <Text style={{ ...stylesFont.fontNolanBold, color: Color.BLUE_FB, fontSize: _moderateScale(12) }}>Chi tiết</Text>
                                                <Image style={sizeIcon.xxxs} source={require('../../NewIcon/arrowRightBlue.png')} />
                                            </TouchableOpacity>
                                        </View>
                                        <ScrollView
