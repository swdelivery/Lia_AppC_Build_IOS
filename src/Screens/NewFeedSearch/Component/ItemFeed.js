...
import { BASE_COLOR, BG_BEAUTY, BG_CLEAR, BG_GREY_OPACITY_3, BG_GREY_OPACITY_5, BG_GREY_OPACITY_7, BG_GREY_OPACITY_9, BLACK_OPACITY_8, BLUE, BLUE_FB, BLUE_OCEAN, BLUE_TITLE, GREY, GREY_FOR_TITLE, MAIN_OPACITY_8, SECOND_COLOR, THIRD_COLOR, TITLE_GREY, WHITE, BG_GREY_OPACITY_2 } from '../../../Constant/Color';
...
const ItemFeed = (props) => {
    ...
    _handleDetail = () => {
        ...
        navigation.navigate(ScreenKey.DETAIL_NEW_FEED, { idPost: props?.data?._id, isSearch: true })
    }
                ...
                <View style={[styles.contentFeed]}>
                    ...
                    <View style={[styleElement.rowAliCenter, { paddingHorizontal: _moderateScale(8 * 2), justifyContent: 'space-between' }]}>
                        ...
                        onPress={()=>{
                            ...
                            setListImagesSeeCurr(props?.data?.template?.data?.imageBeforeTreatment)
                        }}
