...
const ModalInfoBooking = (props) => {
  ...
  const _renderStatusBooking = () => {
    switch (props?.data?.status) {
      ...
      case "CANCEL":
        return (
          <Text style={[stylesFont.fontNolan500, { color: RED }]}>Đã Huỷ</Text>
        );
        ...
        >
          ...
          >
            Chi nhánh:{" "}
            {
              <Text
                style={[
                  stylesFont.fontNolanBold,
                  { fontSize: _moderateScale(16), color: "#EC3A79" },
                ]}
              >
          ...
          >
            Thời gian:{" "}
            {
              ...
              >
                {moment(
                  props?.data?.appointmentDateFinal?.from?.dateTime
                ).format("LT")}{" "}
                ->{" "}
                {moment(props?.data?.appointmentDateFinal?.to?.dateTime).format(
                  "LT"
                )}
              </Text>
            }
          ...
          >
            {moment(props?.data?.appointmentDateFinal?.date).format(
              "DD/MM/YYYY"
            )}
          </Text>
          ...
          >
            Trạng thái: {_renderStatusBooking()}
          </Text>
          ...
          >
            ...
            <Text style={styles.textInput}>{props?.data?.description}</Text>
          </View>
          ...
          >
            ...
            {props?.data?.status == "WAIT" ? (
              ...
              >
                <Text
                  style={[stylesFont.fontNolanBold, styles.btnConfirm__text]}
                >
                  Đặt cọc
                </Text>
              </TouchableOpacity>
