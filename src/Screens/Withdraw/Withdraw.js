...
import { randomStringFixLengthCode, formatMonney, alertCustomNotAction } from '../../Constant/Utils';
...
import { getListBank, createPaymentRequestForWalletCommission } from '../../Redux/Action/Affiilate';
            ...
            <KeyboardAwareScrollView>
                <View style={{ marginTop: _moderateScale(8 * 2), paddingHorizontal: _moderateScale(8 * 3) }}>
                    <View style={[styleElement.rowAliCenter]}>
                        <Image style={[sizeIcon.llg]} source={require('../../Icon/a_wallet.png')} />
                    ...
                    <Text style={[stylesFont.fontNolan, { fontSize: _moderateScale(16), marginTop: _moderateScale(8 * 2) }]}>
                    ...
                    <View style={[styleElement.rowAliCenter, { marginTop: _moderateScale(8) }]}>
                        ...
                        <Text style={[stylesFont.fontNolanBold, { flex: 1, marginLeft: _moderateScale(8), fontSize: _moderateScale(16), color: BLUE_FB }]}>
                    ...
                    <TextInput
                        ...
                        keyboardType={'number-pad'}
                        onChangeText={(e) => {
                            setMoneyForWithdraw(e.split('.').join("").toString().replace(/\B(?=(\d{3})+(?!\d))/g, "."))
                        }}
                        style={[stylesFont.fontNolanBold, styles.textInputCode]}
